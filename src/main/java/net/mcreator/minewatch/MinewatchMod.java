...
import net.mcreator.minewatch.init.MinewatchModTabs;
import net.mcreator.minewatch.init.MinewatchModItems;
...
public class MinewatchMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(MinewatchMod.class);
	...
	public void onInitialize() {
		...
		LOGGER.info("Initializing MinewatchMod");
		MinewatchModTabs.load();
		MinewatchModVariables.variablesLoad();
		MinewatchModItems.load();
		tick();
